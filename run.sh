...
./build/release/duckdb_min_max -f sql_commands_2.txt 2>> raw_data_min_max.csv
./build/release/duckdb_cluster -f sql_commands_2.txt 2>> raw_data_cluster.csv
./build/release/duckdb_bloom -f sql_commands_2.txt 2>> raw_data_bloom.csv
> $1
