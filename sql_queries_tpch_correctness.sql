...
COPY customer FROM 'tpch_small/customer.csv' (FORMAT 'csv', force_not_null ('c_custkey', 'c_name', 'c_address', 'c_nationkey', 'c_phone', 'c_acctbal', 'c_mktsegment', 'c_comment'), delimiter ',', header 1);
COPY lineitem FROM 'tpch_small/lineitem.csv' (FORMAT 'csv', force_not_null ('l_orderkey', 'l_partkey', 'l_suppkey', 'l_linenumber', 'l_quantity', 'l_extendedprice', 'l_discount', 'l_tax', 'l_returnflag', 'l_linestatus', 'l_shipdate', 'l_commitdate', 'l_receiptdate', 'l_shipinstruct', 'l_shipmode', 'l_comment'), delimiter ',', header 1);
COPY nation FROM 'tpch_small/nation.csv' (FORMAT 'csv', force_not_null ('n_nationkey', 'n_name', 'n_regionkey', 'n_comment'), delimiter ',', header 1);
COPY orders FROM 'tpch_small/orders.csv' (FORMAT 'csv', force_not_null ('o_orderkey', 'o_custkey', 'o_orderstatus', 'o_totalprice', 'o_orderdate', 'o_orderpriority', 'o_clerk', 'o_shippriority', 'o_comment'), delimiter ',', header 1);
COPY part FROM 'tpch_small/part.csv' (FORMAT 'csv', force_not_null ('p_partkey', 'p_name', 'p_mfgr', 'p_brand', 'p_type', 'p_size', 'p_container', 'p_retailprice', 'p_comment'), delimiter ',', header 1);
