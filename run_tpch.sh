...
./build/release/duckdb -f sql_commands_tpch.txt 2>> $dir/raw_data_min_max.csv
./build/release/duckdb -f sql_commands_tpch_analyse.txt 2>> $dir/raw_data_min_max.csv
