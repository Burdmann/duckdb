...
with open(out_file,'a+') as f:
    if empty:
        f.write("name,size,rowgroups_scanned,rows_scanned,additional_stat_processing_time,stat_processing_time,production_time,ingestion_time,total_build_time,avg_query_time\n")
    f.write(f"{names},{size},{rowgroups_scanned},{rows_scanned},{additional_stat_processing_time},{stat_processing_time},{production_time},{ingestion_time},{total_build_time},{avg_total_query_time}\n")