...
make STATS=ClusterAdditionalStats LARGE_ADDITIONAL_STATS=false && mv $bin_dir/duckdb $bin_dir/duckdb_cluster_10
make STATS=BloomAdditionalStats LARGE_ADDITIONAL_STATS=false && mv $bin_dir/duckdb $bin_dir/duckdb_bloom_10
make STATS=DictionaryAdditionalStats LARGE_ADDITIONAL_STATS=false && mv $bin_dir/duckdb $bin_dir/duckdb_dictionary_10
