...
COPY call_center FROM 'tpcds_medium/call_center.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY catalog_page FROM 'tpcds_medium/catalog_page.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY catalog_returns FROM 'tpcds_medium/catalog_returns.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY catalog_sales FROM 'tpcds_medium/catalog_sales.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY customer FROM 'tpcds_medium/customer.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY customer_address FROM 'tpcds_medium/customer_address.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY customer_demographics FROM 'tpcds_medium/customer_demographics.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY date_dim FROM 'tpcds_medium/date_dim.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY household_demographics FROM 'tpcds_medium/household_demographics.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY income_band FROM 'tpcds_medium/income_band.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY inventory FROM 'tpcds_medium/inventory.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY item FROM 'tpcds_medium/item.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY promotion FROM 'tpcds_medium/promotion.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY reason FROM 'tpcds_medium/reason.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY ship_mode FROM 'tpcds_medium/ship_mode.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY store FROM 'tpcds_medium/store.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY store_returns FROM 'tpcds_medium/store_returns.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY store_sales FROM 'tpcds_medium/store_sales.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY time_dim FROM 'tpcds_medium/time_dim.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY warehouse FROM 'tpcds_medium/warehouse.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY web_page FROM 'tpcds_medium/web_page.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY web_returns FROM 'tpcds_medium/web_returns.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY web_sales FROM 'tpcds_medium/web_sales.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY web_site FROM 'tpcds_medium/web_site.csv' (FORMAT 'csv', delimiter ',', header 1);
