...
COPY call_center FROM 'tpcds_tiny/call_center.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY catalog_page FROM 'tpcds_tiny/catalog_page.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY catalog_returns FROM 'tpcds_tiny/catalog_returns.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY catalog_sales FROM 'tpcds_tiny/catalog_sales.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY customer FROM 'tpcds_tiny/customer.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY customer_address FROM 'tpcds_tiny/customer_address.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY customer_demographics FROM 'tpcds_tiny/customer_demographics.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY date_dim FROM 'tpcds_tiny/date_dim.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY household_demographics FROM 'tpcds_tiny/household_demographics.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY income_band FROM 'tpcds_tiny/income_band.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY inventory FROM 'tpcds_tiny/inventory.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY item FROM 'tpcds_tiny/item.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY promotion FROM 'tpcds_tiny/promotion.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY reason FROM 'tpcds_tiny/reason.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY ship_mode FROM 'tpcds_tiny/ship_mode.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY store FROM 'tpcds_tiny/store.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY store_returns FROM 'tpcds_tiny/store_returns.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY store_sales FROM 'tpcds_tiny/store_sales.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY time_dim FROM 'tpcds_tiny/time_dim.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY warehouse FROM 'tpcds_tiny/warehouse.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY web_page FROM 'tpcds_tiny/web_page.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY web_returns FROM 'tpcds_tiny/web_returns.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY web_sales FROM 'tpcds_tiny/web_sales.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY web_site FROM 'tpcds_tiny/web_site.csv' (FORMAT 'csv', delimiter ',', header 1);
