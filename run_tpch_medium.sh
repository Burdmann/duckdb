...
./build/release/duckdb_min_max -f sql_queries_tpch_medium.sql 2>> $dir/raw_data_min_max.csv
./build/release/duckdb_cluster -f sql_queries_tpch_medium.sql 2>> $dir/raw_data_cluster.csv
./build/release/duckdb_bloom -f sql_queries_tpch_medium.sql 2>> $dir/raw_data_bloom.csv
...
python3 data_visualiser.py $dir/processed TPC-H