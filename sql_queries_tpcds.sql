...
COPY call_center FROM 'tpcds/call_center.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY catalog_page FROM 'tpcds/catalog_page.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY catalog_returns FROM 'tpcds/catalog_returns.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY catalog_sales FROM 'tpcds/catalog_sales.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY customer FROM 'tpcds/customer.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY customer_address FROM 'tpcds/customer_address.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY customer_demographics FROM 'tpcds/customer_demographics.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY date_dim FROM 'tpcds/date_dim.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY household_demographics FROM 'tpcds/household_demographics.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY income_band FROM 'tpcds/income_band.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY inventory FROM 'tpcds/inventory.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY item FROM 'tpcds/item.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY promotion FROM 'tpcds/promotion.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY reason FROM 'tpcds/reason.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY ship_mode FROM 'tpcds/ship_mode.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY store FROM 'tpcds/store.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY store_returns FROM 'tpcds/store_returns.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY store_sales FROM 'tpcds/store_sales.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY time_dim FROM 'tpcds/time_dim.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY warehouse FROM 'tpcds/warehouse.csv' (FORMAT 'csv', delimiter ',', header 1);
COPY web_page FROM 'tpcds/web_page.csv' (FORMAT 'csv', delimiter ',', header 1);
