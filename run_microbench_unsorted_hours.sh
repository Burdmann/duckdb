...
rm test.db
./build/release/duckdb_min_max -f sql_queries_unsorted_hours.sql 2>> $dir/raw_data_min_max.csv
rm test.db
./build/release/duckdb_cluster -f sql_queries_unsorted_hours.sql 2>> $dir/raw_data_cluster.csv
rm test.db
./build/release/duckdb_bloom -f sql_queries_unsorted_hours.sql 2>> $dir/raw_data_bloom.csv
rm test.db
./build/release/duckdb_dictionary -f sql_queries_unsorted_hours.sql 2>> $dir/raw_data_dictionary.csv
rm test.db
